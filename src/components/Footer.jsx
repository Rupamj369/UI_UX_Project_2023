  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className="w-full flex flex-row justify-between flex-wrap md:mt-0 mt-10 flex-[1.5]">
      ...
      <div className="flex w-full justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]">
        <p
          className="font-normal text-[18px] leading-[27px] text-center text-white
"
        >
          2023 &copy; HooBank.All Rights Reserved.
        </p>
